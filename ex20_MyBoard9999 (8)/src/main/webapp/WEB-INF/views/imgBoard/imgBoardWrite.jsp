...
<div class="container1">
	<form action="imgBoardWriteAction" method="post" name="" enctype="multipart/form-data">
	  <label for="exampleFormControlInput1">카테고리</label>
	  <select name="categoryList"  id="categoryList" class="form-control" style="width: 100%;">
        <option value="1">원두</option>
        <option value="2">콜드브루</option>
      </select>
	  <div class="form-group">
	    <label for="exampleFormControlInput1">글쓴이</label>
	    <input type="text" name="imgBoardName"class="form-control" id="exampleFormControlInput1" >
	  </div>
	  <div class="form-group">
	    <label for="exampleFormControlInput1">글제목</label>
	    <input type="text" name="imgBoardTitle"class="form-control" id="exampleFormControlInput1" placeholder="글 제목">
	  </div>
	  <div class="form-group">
	    <label for="exampleFormControlTextarea1">글 내용</label>
	    <textarea name="imgBoardContent" class="form-control" id="exampleFormControlTextarea1" placeholder="글 내용" rows="6"></textarea>
	  </div>
	  <div class="form-group">
...
<!-- 		    <input type="file" name="filename" class="form-control" id="exampleFormControlInput1"> -->
  	  ...
  	  <button type="button" onclick="location.href='imgBoardWrite'" class="btn btn-outline-primary">취소하기</button>
